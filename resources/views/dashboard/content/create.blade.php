...
<div id="page-wrapper">
	...
	<div class="container-fluid">
        ...
        <div class="row">
        {!! Form::open(array('action'=>'Dashboard\ContentController@store','method'=>'post','role'=>'form')) !!}
        	<div class="col-lg-8">
        	...
        	<div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group" id="value-image-product">
                        <input type="text" class="form-control" id="image_intro" name="thumbnail" readonly="">
