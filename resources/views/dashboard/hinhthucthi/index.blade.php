		...
		<div class="row">
			<div class="col-lg-6">
				<div class="form-group">
					<a href="{{ url('/hinhthucthi/create') }}" title=""><button type="button" class="btn btn-default">Thêm</button></a>
				</div>
                        <table class="table table-bordered table-hover">
                        	...
                        	<tbody>
                        	<?php $stt = 1; ?>
                        	@foreach(Hinhthucthi::all() as $value)
                        		<tr>
                        			<td>{{ $stt }}</td>
                        			<td>{{ $value->ten }}</td>
                        			...
                        			<td>
                        				<button type="button" data-delete="{{ $value->id }}" class="btn btn-default btn-delete">
                                        	...
                                        	<a href="{{ url('/hinhthucthi/'.$value->id.'/edit') }}" title="">
