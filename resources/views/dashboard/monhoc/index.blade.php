		...
		<div class="row">
			<div class="col-lg-6">
				<div class="form-group">
					<a href="{{ url('/monhoc/create') }}" title=""><button type="button" class="btn btn-default">Thêm</button></a>
				</div>
                        <table class="table table-bordered table-hover">
                        	<thead>
                        		<tr>
                        			...
                        			<th>Tên Môn</th>
                                    <th>Môn thi bắt buộc</th>
                                    <th>Môn xét tốt nghiệp</th>
                        		...
                        		<tr>
                        			...
                        			<td>
                        				<button type="button" data-delete="{{ $value->id }}" class="btn btn-default btn-delete">
                                        	...
                                        	<a href="{{ url('/monhoc/'.$value->id.'/edit') }}" title="">
