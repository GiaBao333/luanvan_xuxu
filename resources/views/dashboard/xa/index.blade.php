		...
		<div class="row">
			<div class="col-lg-6">
				<div class="form-group">
					<a href="{{ url('/xa/create') }}" title=""><button type="button" class="btn btn-default">Thêm</button></a>
				</div>
