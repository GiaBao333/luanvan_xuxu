		...
		<div class="row">
			<div class="col-lg-12">
				<div class="form-group">
					<a href="{{ url('/canbo/create') }}" title=""><button type="button" class="btn btn-default">Thêm</button></a>
				</div>
